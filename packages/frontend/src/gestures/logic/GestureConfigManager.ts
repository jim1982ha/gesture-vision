/* FILE: packages/frontend/src/gestures/logic/GestureConfigManager.ts */
import type { AppStore } from '#frontend/core/state/app-store.js';
import { getGestureDisplayInfo } from '#frontend/ui/helpers/index.js';
import { BUILT_IN_HAND_GESTURES, normalizeNameForMtx, type CustomGestureMetadata, type GestureConfig, type PoseConfig } from '#shared/index.js';

/**
 * Manages caching and filtering of gesture configurations based on current app state.
 */
