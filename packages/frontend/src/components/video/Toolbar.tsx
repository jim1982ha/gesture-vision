...
export const Toolbar = () => {
    ...
    return (
        <div id="video-toolbar-container" className="absolute top-2 right-2 flex flex-col items-end gap-2 pointer-events-auto">
            ...
            <button id="videoSizeToggleButton" className="btn btn-icon overlay-surface rounded-full" onClick={() => actions.toggleVideoExpanded()} title={translate(isVideoExpanded ? 'constrainVideo' : 'expandVideo')}>
